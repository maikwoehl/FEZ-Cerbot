...
namespace GHIElectronics.Gadgeteer
{
    ...
    public class FEZCerbot : GT.Mainboard
    {
        ...
        public FEZCerbot()
        {
            ...
            socket.NativeI2CWriteRead = nativeI2C;
            socket.AnalogInput3 = new FEZCerbot_AIN((Cpu.Pin)12);
            socket.AnalogInput4 = new FEZCerbot_AIN((Cpu.Pin)13);
            socket.AnalogInput5 = new FEZCerbot_AIN((Cpu.Pin)14);
            socket.AnalogOutput = new FEZCerbot_AnalogOut((Cpu.Pin)14);
            socket.PWM7 = new FEZCerbot_PWM((Cpu.Pin)17);
            socket.PWM8 = new FEZCerbot_PWM((Cpu.Pin)18);
            socket.PWM9 = new FEZCerbot_PWM((Cpu.Pin)19);
            GT.Socket.SocketInterfaces.RegisterSocket(socket);
    ...
    internal class FEZCerbot_PWM : GT.Socket.SocketInterfaces.PWM
    {
        ...
        public FEZCerbot_PWM(Cpu.Pin pin)
        {
            this.pin = pin;
        }
    ...
    internal class FEZCerbot_AIN : GT.Socket.SocketInterfaces.AnalogInput
    {
        ...
        public FEZCerbot_AIN(Cpu.Pin pin)
        {
            this.pin = pin;
        }
