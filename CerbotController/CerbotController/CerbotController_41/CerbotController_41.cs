...
namespace Gadgeteer.Modules.GHIElectronics
{
    ...
    public class CerbotController : GTM.Module
    {
        ...
        // GTM.GHIElectronics.CerbotController. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the CerbotController module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public CerbotController(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the CerbotController is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="CerbotController"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="CerbotController"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="CerbotController"/></param>
        public delegate void ButtonEventHandler(CerbotController sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="CerbotController"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="CerbotController"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="CerbotController"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(CerbotController sender, ButtonState buttonState)
        {
